...
C {devices/vsource_np.sym} -770 -100 0 0 {name=VREF value="dc {vref_val}"}
...
N -110 -20 -150 -20 {}
C {devices/lab_wire.sym} -150 -20 0 0 {name=l0 lab=vout}
N -110 20 -150 20 {}
...
N -770 -130 -770 -170 {}
C {devices/lab_wire.sym} -770 -170 0 1 {name=l16 lab=vref}
N -770 -70 -770 -30 {}
C {devices/lab_wire.sym} -770 -30 2 0 {name=l17 lab=vss}
N -420 -310 -420 -270 {}
C {devices/lab_wire.sym} -420 -270 2 0 {name=l18 lab=n2}
N -460 -340 -500 -340 {}
C {devices/lab_wire.sym} -500 -340 0 0 {name=l19 lab=nmir}
N -420 -370 -420 -410 {}
C {devices/lab_wire.sym} -420 -410 0 1 {name=l20 lab=vdd}
N -420 -340 -380 -340 {}
C {devices/lab_wire.sym} -380 -340 0 1 {name=l21 lab=vdd}
N -200 -310 -200 -270 {}
C {devices/lab_wire.sym} -200 -270 2 0 {name=l22 lab=n3}
N -240 -340 -280 -340 {}
C {devices/lab_wire.sym} -280 -340 0 0 {name=l23 lab=nmir}
N -200 -370 -200 -410 {}
C {devices/lab_wire.sym} -200 -410 0 1 {name=l24 lab=vdd}
N -200 -340 -160 -340 {}
C {devices/lab_wire.sym} -160 -340 0 1 {name=l25 lab=vdd}
N 20 -310 20 -270 {}
C {devices/lab_wire.sym} 20 -270 2 0 {name=l26 lab=nmir}
N -20 -340 -60 -340 {}
C {devices/lab_wire.sym} -60 -340 0 0 {name=l27 lab=vb2}
N 20 -370 20 -410 {}
C {devices/lab_wire.sym} 20 -410 0 1 {name=l28 lab=n2}
N 20 -340 60 -340 {}
C {devices/lab_wire.sym} 60 -340 0 1 {name=l29 lab=vdd}
N 240 -310 240 -270 {}
C {devices/lab_wire.sym} 240 -270 2 0 {name=l30 lab=ngate}
N 200 -340 160 -340 {}
C {devices/lab_wire.sym} 160 -340 0 0 {name=l31 lab=vb2}
N 240 -370 240 -410 {}
C {devices/lab_wire.sym} 240 -410 0 1 {name=l32 lab=n3}
N 240 -340 280 -340 {}
C {devices/lab_wire.sym} 280 -340 0 1 {name=l33 lab=vdd}
N 130 310 130 270 {}
C {devices/lab_wire.sym} 130 270 0 1 {name=l34 lab=nmir}
N 90 340 50 340 {}
C {devices/lab_wire.sym} 50 340 0 0 {name=l35 lab=vb1}
N 130 370 130 410 {}
C {devices/lab_wire.sym} 130 410 2 0 {name=l36 lab=vss}
N 130 340 170 340 {}
C {devices/lab_wire.sym} 170 340 0 1 {name=l37 lab=vss}
N 350 310 350 270 {}
C {devices/lab_wire.sym} 350 270 0 1 {name=l38 lab=ngate}
N 310 340 270 340 {}
C {devices/lab_wire.sym} 270 340 0 0 {name=l39 lab=vb1}
N 350 370 350 410 {}
C {devices/lab_wire.sym} 350 410 2 0 {name=l40 lab=vss}
N 350 340 390 340 {}
C {devices/lab_wire.sym} 390 340 0 1 {name=l41 lab=vss}
N 570 310 570 270 {}
C {devices/lab_wire.sym} 570 270 0 1 {name=l42 lab=n4}
N 530 340 490 340 {}
C {devices/lab_wire.sym} 490 340 0 0 {name=l43 lab=vb1}
N 570 370 570 410 {}
C {devices/lab_wire.sym} 570 410 2 0 {name=l44 lab=vss}
N 570 340 610 340 {}
C {devices/lab_wire.sym} 610 340 0 1 {name=l45 lab=vss}
N 460 -310 460 -270 {}
C {devices/lab_wire.sym} 460 -270 2 0 {name=l46 lab=vout}
N 420 -340 380 -340 {}
C {devices/lab_wire.sym} 380 -340 0 0 {name=l47 lab=ngate}
N 460 -370 460 -410 {}
C {devices/lab_wire.sym} 460 -410 0 1 {name=l48 lab=vdd}
N 460 -340 500 -340 {}
C {devices/lab_wire.sym} 500 -340 0 1 {name=l49 lab=vdd}

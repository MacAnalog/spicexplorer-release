...
N 190 0 250 0 {}
N 150 70 190 70 {}
C {devices/lab_wire.sym} -190 90 2 0 {name=l0 lab=otao}
C {devices/lab_wire.sym} -90 0 0 1 {name=l1 lab=otax}
C {devices/lab_wire.sym} 90 0 0 0 {name=l2 lab=otax}
...
C {devices/opin.sym} 525 0 0 0 {name=p1 lab=otax}
C {devices/opin.sym} 525 120 0 0 {name=p2 lab=otao}

...
# remote. Live Spectre + TSMC-65 runs happen only on a Cadence-equipped host, so
...
# Spectre + TSMC-65 runs happen ONLY on a Cadence-equipped host; everywhere else these
...
def probe_cadence() -> dict[str, Any]:
    ...
    return {
        ...
        "cadence_detail": (
            ...
            "configured — live Spectre / TSMC-65 unavailable; skip the live-Spectre gate."
        ),
        "cadence_source": None,
    }

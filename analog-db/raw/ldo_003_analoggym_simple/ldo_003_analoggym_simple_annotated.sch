...
C {devices/vsource_np.sym} -680 260 0 0 {name=VLP value="dc 0"}
...
C {devices/lab_wire.sym} -80 260 0 0 {name=l2 lab=lp_brk}
C {devices/lab_wire.sym} 240 320 2 0 {name=l3 lab=ncz}
C {devices/lab_wire.sym} 475 320 2 0 {name=l4 lab=ncz}
C {devices/lab_wire.sym} -260 0 0 1 {name=l5 lab=ndiode}
C {devices/lab_wire.sym} -80 0 0 0 {name=l6 lab=ndiode}
C {devices/lab_wire.sym} 20 170 0 1 {name=l7 lab=ndiode}
C {devices/lab_wire.sym} -360 90 2 0 {name=l8 lab=ngate}
C {devices/lab_wire.sym} 180 200 0 1 {name=l9 lab=ngate}
C {devices/lab_wire.sym} 260 0 0 0 {name=l10 lab=ngate}
C {devices/lab_wire.sym} -360 350 2 0 {name=l11 lab=ntail}
C {devices/lab_wire.sym} -90 520 0 1 {name=l12 lab=vb}
C {devices/lab_wire.sym} 360 90 2 0 {name=l13 lab=vout}
C {devices/lab_wire.sym} -260 260 0 1 {name=l14 lab=vref}
C {devices/lab_wire.sym} -420 94 2 0 {name=l15 lab=vdd}
...
C {devices/lab_wire.sym} -250 614 2 0 {name=l20 lab=vss}
C {devices/lab_wire.sym} -680 350 2 0 {name=l21 lab=vout}
C {devices/lab_wire.sym} -680 610 2 0 {name=l22 lab=vss}
C {devices/lab_wire.sym} -680 90 2 0 {name=l23 lab=vss}
C {devices/lab_wire.sym} -680 430 0 1 {name=l24 lab=vb}
C {devices/lab_wire.sym} -680 170 0 1 {name=l25 lab=lp_brk}
C {devices/lab_wire.sym} -680 -90 0 1 {name=l26 lab=vref}
...
B 10 -528 182 188 338 {fill=0}
T {NMOS Differential Pair} -528 164 0 0 0.3 0.3 {layer=10}

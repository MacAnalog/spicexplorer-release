...
def test_differential_view_delegates_scalars_on_the_protocol_signature():
    ...
    power), vos and t_settle went missing on 8 tsmc-n65 amplifiers while the AC metrics
...
def test_noise_iprobe_follows_the_testbench_template(template, expected):
    ...
    noise measurement on 16 tsmc-n65 amplifiers until someone read the published table.
    """

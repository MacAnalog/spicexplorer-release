...
only_toplevel=true
value="
* TESTBENCH tran_chopper_ripple_rrl -- DUT ccia-dut-chopper-w-positive-feedback-rrl
...
.control
  ...
  * railed, dead output - not a working amplifier. See CMFB_PLAN.md.
  ...
  write tran_chopper_ripple_rrl.raw
  * --- waveform output ---------------------------------------
  * hardcopy -> SVG, works in batch. plot -> interactive only.
  hardcopy tran_chopper_ripple_rrl_vodm.svg vodm
  hardcopy tran_chopper_ripple_rrl_cm.svg v(voutp) v(voutn) vocm
  plot vodm

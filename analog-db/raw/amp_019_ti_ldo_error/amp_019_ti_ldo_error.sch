...
C {devices/capa_np.sym} 935 260 1 0 {name=CC value='c_comp'}
C {devices/res_np.sym} -150 260 1 0 {name=RND value='r_nd'}
C {devices/res_np.sym} 120 260 1 0 {name=RZ value='r_z'}
...
C {devices/lab_wire.sym} -120 320 2 0 {name=l8 lab=na}
C {devices/lab_wire.sym} 340 200 0 1 {name=l9 lab=na}
C {devices/lab_wire.sym} -520 170 0 1 {name=l10 lab=nb}
C {devices/lab_wire.sym} -340 90 2 0 {name=l11 lab=nb}
C {devices/lab_wire.sym} -340 170 0 1 {name=l12 lab=nb}
C {devices/lab_wire.sym} 150 320 2 0 {name=l13 lab=nb}
C {devices/lab_wire.sym} 30 260 0 0 {name=l14 lab=ncz}
C {devices/lab_wire.sym} 965 320 2 0 {name=l15 lab=ncz}
C {devices/lab_wire.sym} -600 0 0 1 {name=l16 lab=nd}
C {devices/lab_wire.sym} -240 0 0 1 {name=l17 lab=nd}
C {devices/lab_wire.sym} 380 170 0 1 {name=l18 lab=nd}
C {devices/lab_wire.sym} -300 320 2 0 {name=l19 lab=ne}
C {devices/lab_wire.sym} 620 0 0 0 {name=l20 lab=ne}
C {devices/lab_wire.sym} 380 350 2 0 {name=l21 lab=nlev}
C {devices/lab_wire.sym} 380 430 0 1 {name=l22 lab=nlev}
C {devices/lab_wire.sym} -700 350 2 0 {name=l23 lab=tail}
C {devices/lab_wire.sym} -660 260 0 0 {name=l24 lab=vinn}
C {devices/lab_wire.sym} -480 320 2 0 {name=l25 lab=vinp}
C {devices/lab_wire.sym} 720 90 2 0 {name=l26 lab=vout}
C {devices/lab_wire.sym} -760 94 2 0 {name=l27 lab=vdd}
C {devices/lab_wire.sym} 440 354 2 0 {name=l28 lab=vdd}
C {devices/lab_wire.sym} -400 94 2 0 {name=l29 lab=vdd}
C {devices/lab_wire.sym} 780 94 2 0 {name=l30 lab=vdd}
C {devices/lab_wire.sym} -400 354 2 0 {name=l31 lab=vdd}
C {devices/lab_wire.sym} -760 354 2 0 {name=l32 lab=vss}
C {devices/lab_wire.sym} -580 354 2 0 {name=l33 lab=vss}
C {devices/lab_wire.sym} 100 614 2 0 {name=l34 lab=vss}
C {devices/lab_wire.sym} -760 614 2 0 {name=l35 lab=vss}
C {devices/lab_wire.sym} -400 614 2 0 {name=l36 lab=vss}
C {devices/lab_wire.sym} 440 614 2 0 {name=l37 lab=vss}
C {devices/lab_wire.sym} 780 354 2 0 {name=l38 lab=vss}
C {devices/ipin.sym} -1035 260 0 0 {name=p0 lab=vinn}
C {devices/ipin.sym} -1035 380 0 0 {name=p1 lab=vinp}
C {devices/opin.sym} 1245 30 0 0 {name=p2 lab=vout}
C {devices/opin.sym} 1245 260 0 0 {name=p3 lab=ibias}

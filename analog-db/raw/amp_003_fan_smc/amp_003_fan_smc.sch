...
S {}
E {}
T {amp_003_fan_smc} -1740 -200 0 0 0.4 0.4 {}
...
C {devices/sg13_lv_pmos_np.sym} 910 260 0 0 {name=M9 model=sg13_lv_pmos spiceprefix=X w=x_dut_xm9_w l=x_dut_xm9_l m=x_dut_xm9_m}
N -1700 430 -1700 490 {}
N -1700 550 -1700 610 {}
N -1440 0 -1440 94 {}
N -1440 260 -1440 354 {}
...
C {devices/lab_wire.sym} 890 200 0 1 {name=l16 lab=VINP}
C {devices/lab_wire.sym} 1275 350 2 0 {name=l17 lab=VOUT}
C {devices/lab_wire.sym} 1475 90 2 0 {name=l18 lab=VOUT}
C {devices/lab_wire.sym} -940 0 0 1 {name=l19 lab=VOUTN}
C {devices/lab_wire.sym} -1040 170 0 1 {name=l20 lab=VOUTN}
C {devices/lab_wire.sym} 1010 0 0 0 {name=l21 lab=VOUTN}
C {devices/lab_wire.sym} -580 0 0 1 {name=l22 lab=net013}
C {devices/lab_wire.sym} -240 0 0 1 {name=l23 lab=net013}
C {devices/lab_wire.sym} 180 -60 0 1 {name=l24 lab=net013}
C {devices/lab_wire.sym} 360 -60 0 1 {name=l25 lab=net013}
C {devices/lab_wire.sym} 640 0 0 0 {name=l26 lab=net013}
C {devices/lab_wire.sym} -1380 90 2 0 {name=l27 lab=net043}
C {devices/lab_wire.sym} 640 260 0 0 {name=l28 lab=net043}
...
C {devices/lab_wire.sym} -1280 0 0 1 {name=l32 lab=net050}
C {devices/lab_wire.sym} 1110 90 2 0 {name=l33 lab=net050}
C {devices/lab_wire.sym} 1110 170 0 1 {name=l34 lab=net050}
C {devices/lab_wire.sym} 1275 170 0 1 {name=l35 lab=net050}
C {devices/lab_wire.sym} 1375 0 0 0 {name=l36 lab=net050}
C {devices/lab_wire.sym} 930 350 2 0 {name=l37 lab=net063}
C {devices/lab_wire.sym} -860 170 0 1 {name=l38 lab=net31}
C {devices/lab_wire.sym} 220 90 2 0 {name=l39 lab=net31}
C {devices/lab_wire.sym} 930 170 0 1 {name=l40 lab=net31}
C {devices/lab_wire.sym} -340 350 2 0 {name=l41 lab=net54}
C {devices/lab_wire.sym} 40 350 2 0 {name=l42 lab=net56}
C {devices/lab_wire.sym} -920 354 2 0 {name=l43 lab=net31}
C {devices/lab_wire.sym} 990 354 2 0 {name=l44 lab=net31}
C {devices/lab_wire.sym} -740 94 2 0 {name=l45 lab=vdd}
C {devices/lab_wire.sym} -400 94 2 0 {name=l46 lab=vdd}
C {devices/lab_wire.sym} -1440 94 2 0 {name=l47 lab=vdd}
C {devices/lab_wire.sym} 1535 94 2 0 {name=l48 lab=vdd}
C {devices/lab_wire.sym} 100 94 2 0 {name=l49 lab=vdd}
C {devices/lab_wire.sym} 460 94 2 0 {name=l50 lab=vdd}
C {devices/lab_wire.sym} 280 94 2 0 {name=l51 lab=vdd}
C {devices/lab_wire.sym} -1100 94 2 0 {name=l52 lab=vdd}
C {devices/lab_wire.sym} 1170 94 2 0 {name=l53 lab=vdd}
C {devices/lab_wire.sym} 800 94 2 0 {name=l54 lab=vdd}
C {devices/lab_wire.sym} -400 354 2 0 {name=l55 lab=vss}
C {devices/lab_wire.sym} 100 354 2 0 {name=l56 lab=vss}
C {devices/lab_wire.sym} 460 354 2 0 {name=l57 lab=vss}
C {devices/lab_wire.sym} -1100 354 2 0 {name=l58 lab=vss}
C {devices/lab_wire.sym} 1170 354 2 0 {name=l59 lab=vss}
C {devices/lab_wire.sym} -400 614 2 0 {name=l60 lab=vss}
C {devices/lab_wire.sym} 100 614 2 0 {name=l61 lab=vss}
C {devices/lab_wire.sym} -1100 614 2 0 {name=l62 lab=vss}
C {devices/lab_wire.sym} 1170 614 2 0 {name=l63 lab=vss}
C {devices/lab_wire.sym} -1440 354 2 0 {name=l64 lab=vss}
C {devices/lab_wire.sym} 800 354 2 0 {name=l65 lab=vss}
C {devices/lab_wire.sym} 1535 354 2 0 {name=l66 lab=vss}
C {devices/lab_wire.sym} -1700 430 0 1 {name=l67 lab=net013}
C {devices/lab_wire.sym} -1700 610 2 0 {name=l68 lab=vss}
C {devices/lab_wire.sym} 1475 350 2 0 {name=l69 lab=vss}

...
C {devices/lab_wire.sym} 160 0 0 0 {name=l1 lab=ibias}
C {devices/lab_wire.sym} 20 90 2 0 {name=l2 lab=tailp}
C {devices/lab_wire.sym} -190 -90 0 1 {name=l3 lab=vdd}
C {devices/lab_wire.sym} 200 90 2 0 {name=l4 lab=vout}
...
C {devices/opin.sym} 530 0 0 0 {name=p1 lab=ibias}
C {devices/opin.sym} 530 120 0 0 {name=p2 lab=tailp}
C {devices/opin.sym} 530 240 0 0 {name=p3 lab=vout}

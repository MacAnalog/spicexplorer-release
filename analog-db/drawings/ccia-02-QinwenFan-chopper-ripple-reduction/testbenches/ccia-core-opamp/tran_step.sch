...
S {}
E {}
T {amplifier/tran_step -- ccia-core-opamp standalone bench (amp_026_fan_chopper_ota)} 52.5 -1402.5 0 0 0.4 0.4 {}
...
C {devices/gnd.sym} 805 -795 0 0 {name=g26 lab=0}
...
C {devices/lab_wire.sym} 665 -875 0 0 {name=l28 sig_type=std_logic lab=voutp}
...
only_toplevel=true
value="
* TESTBENCH tran_step -- DUT ccia-core-opamp (amp_026_fan_chopper_ota)

...
N 1433.75 -773.75 1475 -773.75 {lab=VOUT}
...
N 460 -603.75 512.5 -603.75 {lab=v_ref_out}
...
N 1401.25 -773.75 1433.75 -773.75 {lab=VOUT}
N 420 -603.75 460 -603.75 {lab=v_ref_out}
C {ldo-005-ti-ldo-buffer-ref/ihp130/ref_amp/ref_amp.sym} 240 -683.75 0 0 {name=x_ref_amp}
...
C {sg13g2_pr/rhigh.sym} 460 -530 0 0 {name=R1
w=\{R_ldo_top_r1_w\}
l=\{R_ldo_top_r1_l\}
model=rhigh
spiceprefix=X
...
C {sg13g2_pr/rhigh.sym} 460 -402.5 0 0 {name=R2
w=\{R_ldo_top_r2_w\}
l=\{R_ldo_top_r2_l\}
model=rhigh
spiceprefix=X
...
C {ldo-005-ti-ldo-buffer-ref/ihp130/error_amp/error_amp.sym} 842.5 -675 0 0 {name=x_error_amp}
...
C {ldo-005-ti-ldo-buffer-ref/ihp130/lpf/lpf_rc.sym} 532.5 -673.75 0 0 {name=x_lpf}
...
C {sg13g2_pr/sg13_hv_pmos.sym} 1210 -760 1 1 {name=Mp

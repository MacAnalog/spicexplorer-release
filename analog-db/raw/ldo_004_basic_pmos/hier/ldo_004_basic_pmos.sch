...
N -330 290 -330 250 {}
C {devices/lab_wire.sym} -330 250 0 1 {name=l5 lab=vout}
N -330 350 -330 390 {}
...
N -550 70 -550 30 {}
C {devices/lab_wire.sym} -550 30 0 1 {name=l9 lab=vref}
N -550 130 -550 170 {}
C {devices/lab_wire.sym} -550 170 2 0 {name=l10 lab=vss}
N 130 290 130 250 {}
C {devices/lab_wire.sym} 130 250 0 1 {name=l11 lab=noutm}
N 90 320 50 320 {}
C {devices/lab_wire.sym} 50 320 0 0 {name=l12 lab=fb}
N 130 350 130 390 {}
C {devices/lab_wire.sym} 130 390 2 0 {name=l13 lab=etail}
N 130 320 170 320 {}
C {devices/lab_wire.sym} 170 320 0 1 {name=l14 lab=vss}
N 350 290 350 250 {}
C {devices/lab_wire.sym} 350 250 0 1 {name=l15 lab=egate}
N 310 320 270 320 {}
C {devices/lab_wire.sym} 270 320 0 0 {name=l16 lab=vref}
N 350 350 350 390 {}
C {devices/lab_wire.sym} 350 390 2 0 {name=l17 lab=etail}
N 350 320 390 320 {}
C {devices/lab_wire.sym} 390 320 0 1 {name=l18 lab=vss}
N 20 -290 20 -250 {}
C {devices/lab_wire.sym} 20 -250 2 0 {name=l19 lab=vout}
N -20 -320 -60 -320 {}
C {devices/lab_wire.sym} -60 -320 0 0 {name=l20 lab=egate}
N 20 -350 20 -390 {}

...
S {}
E {}
T {ldo_009_fer_5t_pass} -700 -540 0 0 0.4 0.4 {}
...
C {devices/capa_np.sym} -330 340 0 0 {name=CMIL value=x_cmil}
C {devices/capa_np.sym} -110 340 0 0 {name=COUT value=x_cout}
C {devices/isource_np.sym} -660 340 0 0 {name=IBI value="dc {x_ibias_val}"}
C {devices/res_np.sym} 110 340 0 0 {name=RBLD value=x_rbleed}
C {devices/res_np.sym} 330 340 0 0 {name=RREF value=x_rref}
...
N -330 -20 -290 -20 {}
C {devices/lab_wire.sym} -290 -20 0 1 {name=l0 lab=otao}
N -330 20 -290 20 {}
C {devices/lab_wire.sym} -290 20 0 1 {name=l1 lab=otax}
N -440 -80 -440 -120 {}
...
N 330 -20 290 -20 {}
C {devices/lab_wire.sym} 290 -20 0 0 {name=l6 lab=lp_brk}
N 330 20 290 20 {}
C {devices/lab_wire.sym} 290 20 0 0 {name=l7 lab=vref}
N 550 -40 590 -40 {}
C {devices/lab_wire.sym} 590 -40 0 1 {name=l8 lab=otao}
N 550 0 590 0 {}
C {devices/lab_wire.sym} 590 0 0 1 {name=l9 lab=otax}
N 550 40 590 40 {}
C {devices/lab_wire.sym} 590 40 0 1 {name=l10 lab=tail}
N 440 100 440 140 {}
C {devices/lab_wire.sym} 440 140 2 0 {name=l11 lab=vss}
N -330 310 -330 270 {}
C {devices/lab_wire.sym} -330 270 0 1 {name=l12 lab=vout}
N -330 370 -330 410 {}
C {devices/lab_wire.sym} -330 410 2 0 {name=l13 lab=otao}
N -110 310 -110 270 {}
C {devices/lab_wire.sym} -110 270 0 1 {name=l14 lab=vout}
N -110 370 -110 410 {}
C {devices/lab_wire.sym} -110 410 2 0 {name=l15 lab=vss}
N -660 310 -660 270 {}
C {devices/lab_wire.sym} -660 270 0 1 {name=l16 lab=vdd}
N -660 370 -660 410 {}
C {devices/lab_wire.sym} -660 410 2 0 {name=l17 lab=nbias}
N 110 310 110 270 {}
C {devices/lab_wire.sym} 110 270 0 1 {name=l18 lab=vout}
N 110 370 110 410 {}
C {devices/lab_wire.sym} 110 410 2 0 {name=l19 lab=vss}
N 330 310 330 270 {}
C {devices/lab_wire.sym} 330 270 0 1 {name=l20 lab=ref0}
N 330 370 330 410 {}
C {devices/lab_wire.sym} 330 410 2 0 {name=l21 lab=vref}
N -660 90 -660 50 {}
C {devices/lab_wire.sym} -660 50 0 1 {name=l22 lab=lp_brk}
N -660 150 -660 190 {}
C {devices/lab_wire.sym} -660 190 2 0 {name=l23 lab=vout}
N -660 -130 -660 -170 {}
C {devices/lab_wire.sym} -660 -170 0 1 {name=l24 lab=ref0}
N -660 -70 -660 -30 {}
C {devices/lab_wire.sym} -660 -30 2 0 {name=l25 lab=vss}
N 20 -310 20 -270 {}
C {devices/lab_wire.sym} 20 -270 2 0 {name=l26 lab=vout}
N -20 -340 -60 -340 {}
C {devices/lab_wire.sym} -60 -340 0 0 {name=l27 lab=otao}
N 20 -370 20 -410 {}

...
B 8 -216 442 425 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -216 424 0 0 0.3 0.3 {layer=8}
B 10 3640 442 4096 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} 3640 424 0 0 0.3 0.3 {layer=10}
B 12 -270 182 1343 338 {fill=0}
T {PMOS Differential Pair} -270 164 0 0 0.3 0.3 {layer=12}
B 21 -995 442 2216 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -995 424 0 0 0.3 0.3 {layer=21}
B 15 -2310 442 -729 598 {fill=0}
T {NMOS Differential Pair} -2310 424 0 0 0.3 0.3 {layer=15}
B 13 -1180 442 2401 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -1180 424 0 0 0.3 0.3 {layer=13}
B 18 -2120 442 -914 598 {fill=0}
T {NMOS Differential Pair} -2120 424 0 0 0.3 0.3 {layer=18}
B 20 -1370 442 2591 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -1370 424 0 0 0.3 0.3 {layer=20}
B 8 -1560 442 2776 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -1560 424 0 0 0.3 0.3 {layer=8}
B 10 -406 442 615 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -406 424 0 0 0.3 0.3 {layer=10}
B 12 -2620 442 4281 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -2620 424 0 0 0.3 0.3 {layer=12}
B 21 -1745 442 2966 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -1745 424 0 0 0.3 0.3 {layer=21}
B 15 -1935 442 3156 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -1935 424 0 0 0.3 0.3 {layer=15}
B 13 -2120 442 3341 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -2120 400 0 0 0.3 0.3 {layer=13}
B 18 -2310 442 3531 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -2310 400 0 0 0.3 0.3 {layer=18}

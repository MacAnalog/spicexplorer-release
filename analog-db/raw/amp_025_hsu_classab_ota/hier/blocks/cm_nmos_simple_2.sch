...
N 190 0 250 0 {}
N -190 60 190 60 {}
C {devices/lab_wire.sym} -190 -90 0 1 {name=l0 lab=csrc_n}
C {devices/lab_wire.sym} -90 0 0 1 {name=l1 lab=mir_n}
C {devices/lab_wire.sym} 190 -90 0 1 {name=l2 lab=mir_n}
...
C {devices/opin.sym} 520 -30 0 0 {name=p1 lab=csrc_n}
C {devices/opin.sym} 520 90 0 0 {name=p2 lab=mir_n}

...
C {devices/vsource_np.sym} -660 -100 0 0 {name=VREF value="dc {vref_val}"}
...
N -220 310 -220 270 {}
C {devices/lab_wire.sym} -220 270 0 1 {name=l14 lab=lp_brk}
N -220 370 -220 410 {}
...
N 0 310 0 270 {}
C {devices/lab_wire.sym} 0 270 0 1 {name=l18 lab=lp_brk}
N 0 370 0 410 {}
...
N -660 90 -660 50 {}
C {devices/lab_wire.sym} -660 50 0 1 {name=l24 lab=lp_brk}
N -660 150 -660 190 {}
C {devices/lab_wire.sym} -660 190 2 0 {name=l25 lab=vout}
N -660 -130 -660 -170 {}
C {devices/lab_wire.sym} -660 -170 0 1 {name=l26 lab=vref}
N -660 -70 -660 -30 {}
C {devices/lab_wire.sym} -660 -30 2 0 {name=l27 lab=vss}
N 20 -310 20 -270 {}
C {devices/lab_wire.sym} 20 -270 2 0 {name=l28 lab=vout}
N -20 -340 -60 -340 {}
C {devices/lab_wire.sym} -60 -340 0 0 {name=l29 lab=egate}
N 20 -370 20 -410 {}
C {devices/lab_wire.sym} 20 -410 0 1 {name=l30 lab=vdd}
N 20 -340 60 -340 {}

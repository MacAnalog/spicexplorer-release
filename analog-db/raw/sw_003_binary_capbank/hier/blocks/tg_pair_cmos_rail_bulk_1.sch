...
C {devices/lab_wire.sym} -190 90 2 0 {name=l2 lab=bot0}
...
C {devices/ipin.sym} -520 0 0 0 {name=p0 lab=V_D0_NOT}
C {devices/ipin.sym} -520 120 0 0 {name=p1 lab=V_D0}
C {devices/opin.sym} 520 -30 0 0 {name=p2 lab=vinp}

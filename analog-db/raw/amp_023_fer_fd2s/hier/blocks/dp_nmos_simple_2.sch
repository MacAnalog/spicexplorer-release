...
N 190 0 250 0 {}
N -190 60 190 60 {}
C {devices/lab_wire.sym} -190 -90 0 1 {name=l0 lab=fn}
C {devices/lab_wire.sym} 190 -90 0 1 {name=l1 lab=fp}
...
C {devices/ipin.sym} -525 0 0 0 {name=p0 lab=vinn}
C {devices/ipin.sym} -525 120 0 0 {name=p1 lab=vinp}
C {devices/iopin.sym} -190 280 0 0 {name=p2 lab=tail}
C {devices/opin.sym} 525 -30 0 0 {name=p3 lab=fn}
C {devices/opin.sym} 525 90 0 0 {name=p4 lab=fp}

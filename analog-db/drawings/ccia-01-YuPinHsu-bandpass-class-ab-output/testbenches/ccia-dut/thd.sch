...
S {}
E {}
T {ia/thd -- ccia-dut standalone bench (ia_001_hsu_bandpass_classab)} 52.5 -1402.5 0 0 0.4 0.4 {}
...
C {devices/vsource.sym} 805 -825 0 0 {name=Vinp value="dc 0 sin(0 \{VA\} \{FSIG\})" savecurrent=true}
...
C {devices/vsource.sym} 665 -905 0 0 {name=Vinn value="dc 0 sin(0 \{-VA\} \{FSIG\})" savecurrent=true}
...
only_toplevel=true
value="
* TESTBENCH thd -- DUT ccia-dut (ia_001_hsu_bandpass_classab)
* template ia/thd_diff ; produces: thd (ngspice `four` total harmonic distortion, %)
...
.control
  ...
  * ngspice `fourier` over the run -> prints harmonics + Total Harmonic Distortion
  fourier 1k vod
  write thd.raw vod
  hardcopy thd_vod.svg vod
.endc
"}

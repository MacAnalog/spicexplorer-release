...
C {devices/lab_wire.sym} -190 90 2 0 {name=l3 lab=bot1}
C {devices/lab_wire.sym} -250 94 2 0 {name=l4 lab=VDD}
C {devices/lab_wire.sym} 250 94 2 0 {name=l5 lab=VSS}
C {devices/ipin.sym} -520 0 0 0 {name=p0 lab=V_D1}
C {devices/ipin.sym} -520 120 0 0 {name=p1 lab=V_D1_NOT}
C {devices/opin.sym} 520 -30 0 0 {name=p2 lab=VCM}
C {devices/opin.sym} 520 90 0 0 {name=p3 lab=bot1}

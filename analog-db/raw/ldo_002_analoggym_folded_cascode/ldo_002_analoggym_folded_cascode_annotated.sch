...
S {}
E {}
T {ldo_002_analoggym_folded_cascode} -1060 -200 0 0 0.4 0.4 {}
...
C {devices/vsource_np.sym} -680 0 0 0 {name=VLP value="dc 0"}
C {devices/vsource_np.sym} -1020 520 0 0 {name=VREF value="dc {vref_val}"}
...
C {devices/lab_wire.sym} -140 320 2 0 {name=l2 lab=lp_brk}
C {devices/lab_wire.sym} -360 90 2 0 {name=l3 lab=n2}
C {devices/lab_wire.sym} 40 90 2 0 {name=l4 lab=n3}
C {devices/lab_wire.sym} -180 350 2 0 {name=l5 lab=n4}
C {devices/lab_wire.sym} 220 350 2 0 {name=l6 lab=n4}
C {devices/lab_wire.sym} 510 320 2 0 {name=l7 lab=ncz}
C {devices/lab_wire.sym} 40 350 2 0 {name=l8 lab=ngate}
C {devices/lab_wire.sym} 300 0 0 0 {name=l9 lab=ngate}
C {devices/lab_wire.sym} -360 350 2 0 {name=l10 lab=nmir}
C {devices/lab_wire.sym} -260 0 0 1 {name=l11 lab=nmir}
C {devices/lab_wire.sym} -260 520 0 1 {name=l12 lab=vb1}
C {devices/lab_wire.sym} 180 580 2 0 {name=l13 lab=vb1}
C {devices/lab_wire.sym} -320 260 0 0 {name=l14 lab=vb2}
C {devices/lab_wire.sym} 0 200 0 1 {name=l15 lab=vb2}
...
C {devices/lab_wire.sym} -680 90 2 0 {name=l28 lab=vout}
C {devices/lab_wire.sym} -680 610 2 0 {name=l29 lab=vss}
C {devices/lab_wire.sym} -680 350 2 0 {name=l30 lab=vss}
C {devices/lab_wire.sym} -1020 610 2 0 {name=l31 lab=vss}
C {devices/lab_wire.sym} -680 430 0 1 {name=l32 lab=vb1}
C {devices/lab_wire.sym} -680 170 0 1 {name=l33 lab=vb2}
C {devices/lab_wire.sym} -680 -90 0 1 {name=l34 lab=lp_brk}
C {devices/lab_wire.sym} -1020 430 0 1 {name=l35 lab=vref}
C {devices/opin.sym} 790 30 0 0 {name=p0 lab=vout}
B 8 -348 182 388 338 {fill=0}
T {NMOS Differential Pair} -348 164 0 0 0.3 0.3 {layer=8}

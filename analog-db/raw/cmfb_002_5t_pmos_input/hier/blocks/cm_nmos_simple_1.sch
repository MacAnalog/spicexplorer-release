...
C {devices/sg13_lv_nmos_np.sym} 170 0 0 0 {name=M2 model=sg13_lv_nmos spiceprefix=X w=x_dut_xm2_w l=x_dut_xm2_l m=x_dut_xm2_m}
...
N 190 0 250 0 {}
N -190 60 190 60 {}
C {devices/lab_wire.sym} -190 -90 0 1 {name=l0 lab=mirr}
C {devices/lab_wire.sym} 190 -90 0 1 {name=l1 lab=vcmfb}
...
C {devices/opin.sym} 520 -30 0 0 {name=p1 lab=mirr}
C {devices/opin.sym} 520 90 0 0 {name=p2 lab=vcmfb}

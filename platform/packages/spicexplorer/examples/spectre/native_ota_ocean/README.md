...
requires the research server (Cadence Spectre + TSMC-65 PDK + `virtuoso-bridge`) to
...
```bash
# point at your TSMC-65 model library (NEVER commit the path) + the bridge/ocean profile

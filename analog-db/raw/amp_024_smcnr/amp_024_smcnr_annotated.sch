...
B 8 -698 442 18 598 {fill=0}
T {NMOS Simple Current Mirror} -698 424 0 0 0.3 0.3 {layer=8}
B 10 -528 -78 718 78 {fill=0}
T {PMOS Simple Current Mirror (2 outputs)} -528 -96 0 0 0.3 0.3 {layer=10}
B 12 -698 182 18 338 {fill=0}
T {PMOS Differential Pair} -698 164 0 0 0.3 0.3 {layer=12}

...
- **Reference binding:** original TSMC-180nm AnalogGym decks kept verbatim under `spectre/180nm/`.
...
no accession id of their own. Spectre format, TSMC 180 nm — parse-only here.

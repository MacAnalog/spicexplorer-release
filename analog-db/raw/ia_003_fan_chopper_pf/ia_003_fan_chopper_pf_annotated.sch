...
B 8 -46 442 600 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -46 424 0 0 0.3 0.3 {layer=8}
B 10 4785 442 5236 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} 4785 424 0 0 0.3 0.3 {layer=10}
B 12 -95 182 1513 338 {fill=0}
T {PMOS Differential Pair} -95 164 0 0 0.3 0.3 {layer=12}
B 21 -1040 442 2606 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -1040 424 0 0 0.3 0.3 {layer=21}
B 15 -1795 442 -774 598 {fill=0}
T {NMOS Differential Pair} -1795 424 0 0 0.3 0.3 {layer=15}
B 13 -2735 442 -774 598 {fill=0}
T {NMOS Differential Pair} -2735 424 0 0 0.3 0.3 {layer=13}
B 18 -3110 442 -774 598 {fill=0}
T {NMOS Differential Pair} -3110 424 0 0 0.3 0.3 {layer=18}
B 20 -1230 442 2796 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -1230 424 0 0 0.3 0.3 {layer=20}
B 8 -1980 442 -964 598 {fill=0}
T {NMOS Differential Pair} -1980 424 0 0 0.3 0.3 {layer=8}
B 10 -2545 442 -964 598 {fill=0}
T {NMOS Differential Pair} -2545 424 0 0 0.3 0.3 {layer=10}
B 12 -2920 442 -964 598 {fill=0}
T {NMOS Differential Pair} -2920 424 0 0 0.3 0.3 {layer=12}
B 21 -1420 442 2981 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -1420 424 0 0 0.3 0.3 {layer=21}
B 15 -1605 442 3171 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -1605 424 0 0 0.3 0.3 {layer=15}
B 13 -1795 442 3356 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -1795 400 0 0 0.3 0.3 {layer=13}
B 18 -2735 442 -1529 598 {fill=0}
T {NMOS Differential Pair} -2735 400 0 0 0.3 0.3 {layer=18}
B 20 -3110 442 -1529 598 {fill=0}
T {NMOS Differential Pair} -3110 400 0 0 0.3 0.3 {layer=20}
B 8 -1980 442 3546 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -1980 400 0 0 0.3 0.3 {layer=8}
B 10 -2545 442 -1714 598 {fill=0}
T {NMOS Differential Pair} -2545 400 0 0 0.3 0.3 {layer=10}
B 12 -2920 442 -1714 598 {fill=0}
T {NMOS Differential Pair} -2920 400 0 0 0.3 0.3 {layer=12}
B 21 -231 442 785 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -231 424 0 0 0.3 0.3 {layer=21}
B 15 -3420 442 5426 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -3420 424 0 0 0.3 0.3 {layer=15}
B 13 -2170 442 3736 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -2170 424 0 0 0.3 0.3 {layer=13}
B 18 -2360 442 3921 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -2360 424 0 0 0.3 0.3 {layer=18}
B 20 -2545 442 4111 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -2545 376 0 0 0.3 0.3 {layer=20}
B 8 -2920 442 -2279 598 {fill=0}
T {NMOS Differential Pair} -2920 376 0 0 0.3 0.3 {layer=8}
B 10 -2735 442 4296 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -2735 376 0 0 0.3 0.3 {layer=10}
B 12 -3110 442 -2469 598 {fill=0}
T {NMOS Differential Pair} -3110 376 0 0 0.3 0.3 {layer=12}
B 21 -2920 442 4486 598 {fill=0}
T {COMPLEMENTARY Pass Gate Transmission Gate [alt: tg.pair.cmos]} -2920 352 0 0 0.3 0.3 {layer=21}
B 15 -3110 442 4676 598 {fill=0}

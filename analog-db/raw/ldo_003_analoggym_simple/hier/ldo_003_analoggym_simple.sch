...
N 110 -20 70 -20 {}
C {devices/lab_wire.sym} 70 -20 0 0 {name=l3 lab=vout}
N 110 20 70 20 {}
...
N -550 90 -550 50 {}
C {devices/lab_wire.sym} -550 50 0 1 {name=l17 lab=vref}
N -550 150 -550 190 {}
C {devices/lab_wire.sym} -550 190 2 0 {name=l18 lab=vss}
N 350 310 350 270 {}
C {devices/lab_wire.sym} 350 270 0 1 {name=l19 lab=ntail}
N 310 340 270 340 {}
C {devices/lab_wire.sym} 270 340 0 0 {name=l20 lab=vb}
N 350 370 350 410 {}
C {devices/lab_wire.sym} 350 410 2 0 {name=l21 lab=vss}
N 350 340 390 340 {}
C {devices/lab_wire.sym} 390 340 0 1 {name=l22 lab=vss}
N 20 -310 20 -270 {}
C {devices/lab_wire.sym} 20 -270 2 0 {name=l23 lab=vout}
N -20 -340 -60 -340 {}
C {devices/lab_wire.sym} -60 -340 0 0 {name=l24 lab=ngate}
N 20 -370 20 -410 {}
C {devices/lab_wire.sym} 20 -410 0 1 {name=l25 lab=vdd}
N 20 -340 60 -340 {}
C {devices/lab_wire.sym} 60 -340 0 1 {name=l26 lab=vdd}

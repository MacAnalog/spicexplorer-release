...
C {devices/vsource.sym} 720 -190 0 0 {name=Vdd value=VDD}
...
C {devices/vsource.sym} 880 -350 0 0 {name=Venable value=VDD savecurrent=false}
...
C {code.sym} 630 -1110 0 0 {name=params1 only_toplevel=false value="

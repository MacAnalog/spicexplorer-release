...
S {}
E {}
T {for common mode stability} 790 -540 0 0 0.4 0.4 {}
N 670 -460 670 -360 {
lab=tail}
N 920 -360 1150 -360 {
lab=tail}
...
footprint=1206
device="ceramic capacitor"}
C {iopin.sym} 80 -100 0 1 {name=p16 lab=VSS
}
C {res.sym} 750 -680 1 0 {name=R3
value=1k
footprint=1206
device=resistor
m=1}
C {res.sym} 1050 -680 1 0 {name=R4
value=1k
footprint=1206
device=resistor
m=1}
C {capa.sym} 730 -580 1 0 {name=C3
m=1
value=1p
footprint=1206
device="ceramic capacitor"}
C {capa.sym} 1070 -580 1 0 {name=C4
m=1
value=1p
footprint=1206
device="ceramic capacitor"}
C {res.sym} 820 -580 1 0 {name=R5
value=1k
footprint=1206
device=resistor
m=1}
C {res.sym} 970 -580 1 0 {name=R6
value=1k
footprint=1206
device=resistor
m=1}

...
- `pdk/ihp-sg13g2/` — a PDK binding (also `pdk/sky130/`, `pdk/gf180mcu/`, and the licensed
  `pdk/tsmc-n65/` — NDA-clean `add-binding` transfer, Spectre-only, added with the
  ...
  The tsmc-n65 `sizing.yaml` carries `analysis_params` (VDD 1.2 / VCM 0.45) — the live 1.2 V
...
ICMR 0.88 V, THD 1.62 % (100 mV @ 1 MHz), IIP3 −1.5 dBV; tsmc-n65 (native Spectre, 1.2 V) —

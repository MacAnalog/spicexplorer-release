...
C {ldo-005-ti-ldo-buffer-ref/gf180/ref_amp/ref_amp.sym} 240 -520 0 0 {name=x_ref_amp}
...
C {symbols/ppolyf_u_3k.sym} 460 -366.25 0 0 {name=R1
W=1e-6
L=1e-6
model=ppolyf_u_3k
spiceprefix=X
...
C {symbols/ppolyf_u_3k.sym} 460 -238.75 0 0 {name=R2
W=1e-6
L=1e-6
model=ppolyf_u_3k
spiceprefix=X
...
C {ldo-005-ti-ldo-buffer-ref/gf180/error_amp/error_amp.sym} 842.5 -511.25 0 0 {name=x_error_amp}
...
C {ldo-005-ti-ldo-buffer-ref/gf180/lpf/lpf_rc.sym} 532.5 -510 0 0 {name=x_lpf}
...
C {symbols/pfet_06v0.sym} 1211.25 -600 3 0 {name=MP
L=0.50u
W=0.30u
nf=1
m=1

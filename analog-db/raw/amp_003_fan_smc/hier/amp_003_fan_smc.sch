...
C {devices/sg13_lv_nmos_np.sym} -330 400 0 0 {name=M15 model=sg13_lv_nmos spiceprefix=X w=x_dut_xm15_w l=x_dut_xm15_l m=x_dut_xm15_m}
C {devices/sg13_lv_nmos_np.sym} -110 400 0 0 {name=M16 model=sg13_lv_nmos spiceprefix=X w=x_dut_xm16_w l=x_dut_xm16_l m=x_dut_xm16_m}
...
N -550 430 -550 470 {}
C {devices/lab_wire.sym} -550 470 2 0 {name=l23 lab=VOUT}
N -1180 370 -1180 330 {}
C {devices/lab_wire.sym} -1180 330 0 1 {name=l24 lab=net013}
N -1180 430 -1180 470 {}
C {devices/lab_wire.sym} -1180 470 2 0 {name=l25 lab=vss}
N -90 -370 -90 -330 {}
C {devices/lab_wire.sym} -90 -330 2 0 {name=l26 lab=net043}
N -130 -400 -170 -400 {}
C {devices/lab_wire.sym} -170 -400 0 0 {name=l27 lab=net050}
N -90 -430 -90 -470 {}
C {devices/lab_wire.sym} -90 -470 0 1 {name=l28 lab=vdd}
N -90 -400 -50 -400 {}
C {devices/lab_wire.sym} -50 -400 0 1 {name=l29 lab=vdd}
N 130 -370 130 -330 {}
C {devices/lab_wire.sym} 130 -330 2 0 {name=l30 lab=VOUT}
N 90 -400 50 -400 {}
C {devices/lab_wire.sym} 50 -400 0 0 {name=l31 lab=net050}
N 130 -430 130 -470 {}
C {devices/lab_wire.sym} 130 -470 0 1 {name=l32 lab=vdd}
N 130 -400 170 -400 {}
C {devices/lab_wire.sym} 170 -400 0 1 {name=l33 lab=vdd}
N -310 370 -310 330 {}
C {devices/lab_wire.sym} -310 330 0 1 {name=l34 lab=VOUTN}
N -350 400 -390 400 {}
C {devices/lab_wire.sym} -390 400 0 0 {name=l35 lab=VB3}
N -310 430 -310 470 {}
C {devices/lab_wire.sym} -310 470 2 0 {name=l36 lab=DM_2}
N -310 400 -270 400 {}
C {devices/lab_wire.sym} -270 400 0 1 {name=l37 lab=vss}
N -90 370 -90 330 {}
C {devices/lab_wire.sym} -90 330 0 1 {name=l38 lab=net050}
N -130 400 -170 400 {}
C {devices/lab_wire.sym} -170 400 0 0 {name=l39 lab=VB3}
N -90 430 -90 470 {}
C {devices/lab_wire.sym} -90 470 2 0 {name=l40 lab=net063}
N -90 400 -50 400 {}
C {devices/lab_wire.sym} -50 400 0 1 {name=l41 lab=vss}
N 130 370 130 330 {}
C {devices/lab_wire.sym} 130 330 0 1 {name=l42 lab=DM_2}
N 90 400 50 400 {}
C {devices/lab_wire.sym} 50 400 0 0 {name=l43 lab=VB4}
N 130 430 130 470 {}
C {devices/lab_wire.sym} 130 470 2 0 {name=l44 lab=vss}
N 130 400 170 400 {}
C {devices/lab_wire.sym} 170 400 0 1 {name=l45 lab=vss}
N 350 370 350 330 {}
C {devices/lab_wire.sym} 350 330 0 1 {name=l46 lab=net063}
N 310 400 270 400 {}
C {devices/lab_wire.sym} 270 400 0 0 {name=l47 lab=VB4}
N 350 430 350 470 {}
C {devices/lab_wire.sym} 350 470 2 0 {name=l48 lab=vss}
N 350 400 390 400 {}
C {devices/lab_wire.sym} 390 400 0 1 {name=l49 lab=vss}
N 570 370 570 330 {}
C {devices/lab_wire.sym} 570 330 0 1 {name=l50 lab=VOUT}
N 530 400 490 400 {}
C {devices/lab_wire.sym} 490 400 0 0 {name=l51 lab=net049}
N 570 430 570 470 {}
C {devices/lab_wire.sym} 570 470 2 0 {name=l52 lab=vss}
N 570 400 610 400 {}
C {devices/lab_wire.sym} 610 400 0 1 {name=l53 lab=vss}

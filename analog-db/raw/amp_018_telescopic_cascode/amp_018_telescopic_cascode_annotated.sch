...
B 8 -374 962 528 1118 {fill=0}
T {NMOS Simple Current Mirror} -374 944 0 0 0.3 0.3 {layer=8}
B 10 -536 442 196 858 {fill=0}
T {NMOS Cascode Differential Pair Differential Pair} -536 424 0 0 0.3 0.3 {layer=10}
B 12 -536 -78 196 338 {fill=0}
T {PMOS Low Voltage Cascode Current Mirror} -536 -96 0 0 0.3 0.3 {layer=12}
B 21 -506 724 166 836 {fill=0 dash=4}
T {NMOS Differential Pair} -506 706 0 0 0.3 0.3 {layer=21}

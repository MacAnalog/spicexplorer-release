"""LIVE gm/ID operating point on a real TSMC-65 Spectre run (opt-in; needs Cadence).
...
Opt-in gating mirrors `test_ocean_metrics_live.py` (bridge importable + `SPICEXPLORER_TSMC65_MODELS`

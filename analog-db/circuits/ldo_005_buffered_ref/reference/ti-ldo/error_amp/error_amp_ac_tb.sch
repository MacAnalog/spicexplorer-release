...
N 480 380 540 355 {lab=Vn}
N 490 330 540 330 {lab=Vp}
...
C {devices/lab_wire.sym} 490 330 0 0 {name=p3 sig_type=std_logic lab=Vp}
C {devices/lab_wire.sym} 480 380 0 0 {name=p4 sig_type=std_logic lab=Vn}
...
"}
C {error_amp/error_amp.sym} 540 280 0 0 {name=x1}

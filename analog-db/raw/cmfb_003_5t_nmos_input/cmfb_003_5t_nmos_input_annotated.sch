...
B 8 -383 -78 333 78 {fill=0}
T {PMOS Simple Current Mirror} -383 -96 0 0 0.3 0.3 {layer=8}
B 10 -213 182 673 598 {fill=0}
T {NMOS Simple Current Mirror} -213 164 0 0 0.3 0.3 {layer=10}
B 12 -383 182 333 338 {fill=0}
T {NMOS Differential Pair} -383 164 0 0 0.3 0.3 {layer=12}

...
N 190 0 250 0 {}
N -190 60 190 60 {}
C {devices/lab_wire.sym} 190 -90 0 1 {name=l0 lab=outm}
C {devices/lab_wire.sym} -190 90 2 0 {name=l1 lab=tail}
C {devices/lab_wire.sym} -90 0 0 1 {name=l2 lab=vinn}
C {devices/lab_wire.sym} 90 0 0 0 {name=l3 lab=vinp}
C {devices/lab_wire.sym} -190 -90 0 1 {name=l4 lab=vout}
...
C {devices/opin.sym} 520 90 0 0 {name=p4 lab=outm}

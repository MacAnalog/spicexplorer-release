...
B 8 -1216 442 726 598 {fill=0}
T {NMOS Simple Current Mirror} -1216 424 0 0 0.3 0.3 {layer=8}
B 10 -868 -78 -152 78 {fill=0}
T {PMOS Simple Current Mirror} -868 -96 0 0 0.3 0.3 {layer=10}
B 12 -698 442 208 598 {fill=0}
T {NMOS Simple Current Mirror} -698 424 0 0 0.3 0.3 {layer=12}
B 21 164 -78 888 78 {fill=0}
T {PMOS Simple Current Mirror} 164 -96 0 0 0.3 0.3 {layer=21}
B 15 -868 182 -152 338 {fill=0}
T {NMOS Differential Pair} -868 164 0 0 0.3 0.3 {layer=15}
B 13 172 182 888 338 {fill=0}
T {NMOS Differential Pair} 172 164 0 0 0.3 0.3 {layer=13}

...
C {devices/vsource.sym} 700 -540 0 0 {name=Vin value=V_REF}
...
C {devices/vsource.sym} 1090 -430 0 0 {name=Venable value="dc 0 pwl(0 0 1u 0 1.1u VDD)" savecurrent=false}
...
"}
C {code.sym} 330 -790 0 0 {name=params1 only_toplevel=false value="

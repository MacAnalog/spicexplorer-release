...
## tsmc-n65 binding (Spectre; gm/ID re-sized 2026-07-22)

The `pdk/tsmc-n65` binding carries the **gm/ID re-sizing** from the PPA campaign's hand-design
pass (`campaigns/ppa_tsmc65/hand_design`, tag `gmid_v5`; the pre-campaign committed sizing

...
C {devices/lab_wire.sym} -360 90 2 0 {name=l1 lab=net28}
C {devices/lab_wire.sym} 575 -90 0 1 {name=l2 lab=net28}
C {devices/lab_wire.sym} -170 -90 0 1 {name=l3 lab=net31}
C {devices/lab_wire.sym} 390 90 2 0 {name=l4 lab=net31}
C {devices/lab_wire.sym} -320 60 2 0 {name=l5 lab=vb3}
C {devices/lab_wire.sym} 50 -90 0 1 {name=l6 lab=vb3}
C {devices/lab_wire.sym} 290 0 0 0 {name=l7 lab=vb3}
C {devices/lab_wire.sym} -360 -90 0 1 {name=l8 lab=vb4}
C {devices/lab_wire.sym} -130 60 2 0 {name=l9 lab=vb4}
C {devices/lab_wire.sym} 535 -60 0 1 {name=l10 lab=vb4}

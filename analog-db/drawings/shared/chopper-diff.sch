...
C {shared/transmission_gate_pair.sym} 420 -930 0 0 {name=x1}
C {shared/transmission_gate_pair.sym} 530 -670 0 0 {name=x2}
...
C {shared/transmission_gate_pair.sym} 550 -410 0 0 {name=x3}
...
C {shared/transmission_gate_pair.sym} 310 -250 0 0 {name=x4}

...
C {devices/lab_wire.sym} -190 -90 0 1 {name=l3 lab=net019}
C {devices/lab_wire.sym} 190 90 2 0 {name=l4 lab=net063}
C {devices/lab_wire.sym} 250 94 2 0 {name=l5 lab=net019}
C {devices/lab_wire.sym} -250 94 2 0 {name=l6 lab=net019}
C {devices/ipin.sym} -520 0 0 0 {name=p0 lab=VINN}
C {devices/ipin.sym} -520 120 0 0 {name=p1 lab=VINP}
C {devices/iopin.sym} -190 280 0 0 {name=p2 lab=net019}

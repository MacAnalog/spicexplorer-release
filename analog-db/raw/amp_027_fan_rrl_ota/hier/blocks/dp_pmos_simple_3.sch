...
C {devices/sg13_lv_pmos_np.sym} 170 0 0 0 {name=M6 model=sg13_lv_pmos spiceprefix=X w=x_dut_xm6_w l=x_dut_xm6_l m=x_dut_xm6_m}
...
C {devices/lab_wire.sym} 90 0 0 0 {name=l3 lab=vb4}
C {devices/lab_wire.sym} -90 0 0 1 {name=l4 lab=voutp}
C {devices/lab_wire.sym} 250 94 2 0 {name=l5 lab=vdd}
C {devices/lab_wire.sym} -250 94 2 0 {name=l6 lab=vdd}
C {devices/ipin.sym} -520 0 0 0 {name=p0 lab=voutp}
C {devices/ipin.sym} -520 120 0 0 {name=p1 lab=vb4}
C {devices/iopin.sym} -190 280 0 0 {name=p2 lab=cm_tail}
C {devices/opin.sym} 520 30 0 0 {name=p3 lab=cm_sense}
C {devices/opin.sym} 520 150 0 0 {name=p4 lab=cm_bias}

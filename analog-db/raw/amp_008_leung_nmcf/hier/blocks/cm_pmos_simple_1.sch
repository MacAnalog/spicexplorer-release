...
C {devices/lab_wire.sym} -460 0 0 0 {name=l3 lab=net013}
C {devices/lab_wire.sym} -85 60 2 0 {name=l4 lab=net013}
C {devices/lab_wire.sym} 145 60 2 0 {name=l5 lab=net013}
C {devices/lab_wire.sym} 430 0 0 1 {name=l6 lab=net013}
C {devices/lab_wire.sym} 855 0 0 0 {name=l7 lab=net013}
C {devices/lab_wire.sym} -125 90 2 0 {name=l8 lab=net049}
...
C {devices/opin.sym} 1225 0 0 0 {name=p1 lab=net013}

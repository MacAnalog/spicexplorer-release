...
C {devices/lab_wire.sym} -190 90 2 0 {name=l2 lab=rrl__int_n}
C {devices/lab_wire.sym} -190 -90 0 1 {name=l3 lab=rrl__oa_outp}
...
C {devices/opin.sym} 575 -30 0 0 {name=p2 lab=rrl__oa_outp}
C {devices/opin.sym} 575 90 0 0 {name=p3 lab=rrl__int_n}

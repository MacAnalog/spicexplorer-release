...
S {}
E {}
T {amplifier/tran_step -- two-stage-ota-core standalone bench (amp_025_hsu_classab_ota)} 52.5 -1402.5 0 0 0.4 0.4 {}
...
C {devices/vsource.sym} 805 -825 0 0 {name=Vinp value="dc \{VCM\} pulse(\{VCM\} \{VCM+VSTEP\} \{TSTART\} 1n 1n 1 1)" savecurrent=true}
C {devices/lab_wire.sym} 805 -855 0 0 {name=l23 sig_type=std_logic lab=vinp}
C {devices/gnd.sym} 805 -795 0 0 {name=g24 lab=0}
C {devices/vsource.sym} 665 -905 0 0 {name=Vfb value="dc 0" savecurrent=true}
C {devices/lab_wire.sym} 665 -935 0 0 {name=l25 sig_type=std_logic lab=vinn}
C {devices/lab_wire.sym} 665 -875 0 0 {name=l26 sig_type=std_logic lab=voutp}
C {devices/capa.sym} 1580 -860 0 0 {name=CLoadp m=1 value=\{CL\}}
C {devices/lab_wire.sym} 1580 -890 0 0 {name=l27 sig_type=std_logic lab=voutp}
C {devices/gnd.sym} 1580 -830 0 0 {name=g28 lab=0}
C {devices/capa.sym} 1680 -890 0 0 {name=CLoadn m=1 value=\{CL\}}
C {devices/lab_wire.sym} 1680 -920 0 0 {name=l29 sig_type=std_logic lab=voutn}
C {devices/gnd.sym} 1680 -860 0 0 {name=g30 lab=0}
C {devices/code.sym} 50 -1315 0 0 {name=PARAMS_BENCH
only_toplevel=true
value="
* TESTBENCH tran_step -- DUT two-stage-ota-core (amp_025_hsu_classab_ota)
* template amplifier/tran_step_diff ; produces: t_settle, vfinal
...
.control
  ...
  meas tran vfinal FIND vodm AT=20u
  let verr = abs(vodm - vfinal)
  meas tran tcross WHEN verr=5m FALL=LAST
  let t_settle = tcross - 1u
  print t_settle vfinal
  write tran_step.raw
  hardcopy tran_step_vodm.svg vodm
  hardcopy tran_step_cm.svg voutp voutn
.endc
"}

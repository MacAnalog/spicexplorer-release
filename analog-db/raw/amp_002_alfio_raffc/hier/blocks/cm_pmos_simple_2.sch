...
N 190 0 250 0 {}
N 150 70 190 70 {}
C {devices/lab_wire.sym} -90 0 0 1 {name=l0 lab=VOUTN}
C {devices/lab_wire.sym} 90 0 0 0 {name=l1 lab=VOUTN}
C {devices/lab_wire.sym} -190 90 2 0 {name=l2 lab=net050}
...
C {devices/opin.sym} 520 0 0 0 {name=p1 lab=VOUTN}
C {devices/opin.sym} 520 120 0 0 {name=p2 lab=net050}

...
B 8 -1450 -78 965 78 {fill=0}
T {PMOS Simple Current Mirror} -1450 -96 0 0 0.3 0.3 {layer=8}
B 10 -1102 -78 1432 78 {fill=0}
T {PMOS Simple Current Mirror} -1102 -96 0 0 0.3 0.3 {layer=10}
B 12 -1790 442 -780 598 {fill=0}
T {NMOS Simple Current Mirror} -1790 424 0 0 0.3 0.3 {layer=12}
B 21 -1442 442 -258 598 {fill=0}
T {NMOS Simple Current Mirror} -1442 424 0 0 0.3 0.3 {layer=21}
B 15 242 182 2790 338 {fill=0}
T {PMOS Differential Pair} 242 164 0 0 0.3 0.3 {layer=15}
B 13 -1790 182 -780 338 {fill=0}
T {PMOS Differential Pair} -1790 164 0 0 0.3 0.3 {layer=13}
B 18 -1442 182 -258 338 {fill=0}
T {PMOS Differential Pair} -1442 164 0 0 0.3 0.3 {layer=18}

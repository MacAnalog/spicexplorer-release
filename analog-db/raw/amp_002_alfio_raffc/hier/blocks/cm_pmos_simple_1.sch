...
N 830 0 890 0 {}
N 790 70 830 70 {}
C {devices/lab_wire.sym} 340 90 2 0 {name=l0 lab=DM_1}
C {devices/lab_wire.sym} 55 90 2 0 {name=l1 lab=VB3}
C {devices/lab_wire.sym} 585 90 2 0 {name=l2 lab=VB4}
C {devices/lab_wire.sym} -150 60 2 0 {name=l3 lab=net1}
C {devices/lab_wire.sym} 155 0 0 1 {name=l4 lab=net1}
C {devices/lab_wire.sym} 545 0 0 0 {name=l5 lab=net1}
C {devices/lab_wire.sym} 790 0 0 0 {name=l6 lab=net1}
C {devices/lab_wire.sym} -190 90 2 0 {name=l7 lab=net31}
...
C {devices/opin.sym} 1160 0 0 0 {name=p1 lab=net1}
C {devices/opin.sym} 1160 120 0 0 {name=p2 lab=net31}
C {devices/opin.sym} 1160 240 0 0 {name=p3 lab=VB3}
C {devices/opin.sym} 1160 360 0 0 {name=p4 lab=DM_1}

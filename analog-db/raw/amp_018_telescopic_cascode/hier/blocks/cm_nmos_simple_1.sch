...
C {devices/sg13_lv_nmos_np.sym} 170 0 0 0 {name=M5 model=sg13_lv_nmos spiceprefix=X w=x_dut_xm5_w l=x_dut_xm5_l ng=x_dut_xm5_ng m=x_dut_xm5_m}
...
C {devices/lab_wire.sym} 190 -90 0 1 {name=l1 lab=tail}
...
C {devices/opin.sym} 535 -30 0 0 {name=p1 lab=ibias}
C {devices/opin.sym} 535 90 0 0 {name=p2 lab=tail}

...
B 8 -366 442 386 1118 {fill=0}
T {NMOS Simple Current Mirror (2 outputs)} -366 424 0 0 0.3 0.3 {layer=8}
B 10 -366 182 378 598 {fill=0}
T {PMOS Cascode Differential Pair Differential Pair} -366 164 0 0 0.3 0.3 {layer=10}
B 12 -70 182 688 338 {fill=0}
T {PMOS Differential Pair} -70 164 0 0 0.3 0.3 {layer=12}
B 21 -70 182 868 338 {fill=0}
T {PMOS Differential Pair} -70 140 0 0 0.3 0.3 {layer=21}
B 15 -550 182 688 338 {fill=0}
T {PMOS Differential Pair} -550 164 0 0 0.3 0.3 {layer=15}
B 13 -550 182 868 338 {fill=0}
T {PMOS Differential Pair} -550 140 0 0 0.3 0.3 {layer=13}
B 18 -336 204 356 316 {fill=0 dash=4}
T {PMOS Differential Pair} -336 138 0 0 0.3 0.3 {layer=18}

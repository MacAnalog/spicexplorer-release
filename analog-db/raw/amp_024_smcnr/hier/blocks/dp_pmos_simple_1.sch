...
N 90 0 150 0 {}
N 190 0 250 0 {}
C {devices/lab_wire.sym} -190 90 2 0 {name=l0 lab=outn}
C {devices/lab_wire.sym} 190 90 2 0 {name=l1 lab=outp}
C {devices/lab_wire.sym} -190 -90 0 1 {name=l2 lab=tailp}
...
C {devices/iopin.sym} -190 280 0 0 {name=p2 lab=tailp}
C {devices/opin.sym} 520 30 0 0 {name=p3 lab=outn}
C {devices/opin.sym} 520 150 0 0 {name=p4 lab=outp}

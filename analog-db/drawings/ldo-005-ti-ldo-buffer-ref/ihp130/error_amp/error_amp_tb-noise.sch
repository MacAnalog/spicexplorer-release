...
.endc
"}
C {devices/vsource.sym} 520 -330 0 0 {name=Vdd value=6}
...
C {ldo-005-ti-ldo-buffer-ref/ihp130/error_amp/error_amp.sym} 1050 -630 0 0 {name=xota}
...
C {devices/vsource.sym} 700 -540 0 0 {name=Vcm value="dc 3.0"}

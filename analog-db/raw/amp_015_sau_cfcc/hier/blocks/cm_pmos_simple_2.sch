...
C {devices/lab_wire.sym} -190 90 2 0 {name=l2 lab=net049}
C {devices/lab_wire.sym} 20 90 2 0 {name=l3 lab=net050}
...
C {devices/opin.sym} 530 120 0 0 {name=p2 lab=net049}

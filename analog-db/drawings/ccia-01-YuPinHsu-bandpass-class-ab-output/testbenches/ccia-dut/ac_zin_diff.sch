...
S {}
E {}
T {ia/ac_zin_diff -- ccia-dut standalone bench (ia_001_hsu_bandpass_classab)} 52.5 -1402.5 0 0 0.4 0.4 {}
...
only_toplevel=true
value="
* TESTBENCH ac_zin_diff -- DUT ccia-dut (ia_001_hsu_bandpass_classab)
* template ia/ac_zin_diff ; produces: zin_ohm (static differential input impedance)
...
.control
  ...
  set filetype=ascii
  ac dec 41 0.1 10MEG
  let idiff = (i(Vinp) - i(Vinn))/2
  let zin = 1/mag(idiff)
  let zindb = db(zin)
  meas ac zin_ohm FIND zin AT=100
  print zin_ohm
  write ac_zin_diff.raw
  hardcopy ac_zin_diff_zin.svg zindb
.endc
"}

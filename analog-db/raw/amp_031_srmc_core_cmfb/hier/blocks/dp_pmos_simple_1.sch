...
N 90 0 150 0 {}
N 190 0 250 0 {}
C {devices/lab_wire.sym} -190 -90 0 1 {name=l0 lab=ptail}
C {devices/lab_wire.sym} 90 0 0 0 {name=l1 lab=vinn}
C {devices/lab_wire.sym} -90 0 0 1 {name=l2 lab=vinp}
C {devices/lab_wire.sym} -190 90 2 0 {name=l3 lab=vo1n}
C {devices/lab_wire.sym} 190 90 2 0 {name=l4 lab=vo1p}
...
C {devices/opin.sym} 520 30 0 0 {name=p3 lab=vo1n}
C {devices/opin.sym} 520 150 0 0 {name=p4 lab=vo1p}

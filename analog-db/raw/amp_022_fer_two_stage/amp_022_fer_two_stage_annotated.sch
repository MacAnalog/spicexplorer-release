...
B 8 -868 442 -152 598 {fill=0}
T {NMOS Simple Current Mirror} -868 424 0 0 0.3 0.3 {layer=8}
B 10 -698 -78 868 78 {fill=0}
T {PMOS Simple Current Mirror (2 outputs)} -698 -96 0 0 0.3 0.3 {layer=10}
B 12 144 182 876 598 {fill=0}
T {NMOS Simple Current Mirror} 144 164 0 0 0.3 0.3 {layer=12}
B 21 -868 182 -152 338 {fill=0}
T {PMOS Differential Pair} -868 164 0 0 0.3 0.3 {layer=21}
